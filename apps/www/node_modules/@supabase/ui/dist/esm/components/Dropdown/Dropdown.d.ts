...
side, //Default value
sideOffset, overlay, children, size, className, style, arrow, isNested, }: RootProps): JSX.Element;
...
export declare function RightSlot({ children }: any): JSX.Element;
interface ItemProps {
    children: React.ReactNode;
...
export declare function Item({ children, icon, disabled, onClick, rightSlot, }: ItemProps): JSX.Element;
