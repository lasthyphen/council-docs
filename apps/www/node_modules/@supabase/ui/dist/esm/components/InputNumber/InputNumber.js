...
function InputNumber(_a) {
  ...
  function onInputChange(e) {
    if (props.onChange) props.onChange(e); // update form
  ...
  let inputClasses = [__styles.base]; // const iconUpClasses = [
  ...
  if (props.disabled) inputClasses.push(__styles.disabled); // if (borderless)
    ...
    children: jsx(FormLayout, Object.assign({
      ...
      children: jsxs("div", Object.assign({
        ...
        children: [jsx("input", Object.assign({
          ...
          icon: icon
        }, void 0), error || actions ? jsxs("div", Object.assign({
