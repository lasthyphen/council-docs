...
export declare type ModalProps = RadixProps & Props;
...
declare const Modal: {
    ({ children, customFooter, closable, description, hideFooter, alignFooter, layout, loading, cancelText, onConfirm, onCancel, confirmText, showIcon, title, footerBackground, icon, variant, visible, size, style, overlayStyle, contentStyle, className, overlayClassName, triggerElement, header, ...props }: ModalProps): JSX.Element;
