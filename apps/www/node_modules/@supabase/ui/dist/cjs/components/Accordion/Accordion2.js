...
function Accordion({
  ...
  const __styles = styleHandler['default']('accordion');
  ...
  function handleOnChange(e) {
    ...
    e == typeof String ? e.split(' ') : e; // setCurrentItems(e)

    console.log('about to change state'); // currentItems = e
...
function Item({
  ...
  const __styles = styleHandler['default']('accordion'); // const [open, setOpen] = useState(false)


  const {
    type,
    justified,
    chevronAlign // currentItems,
  ...
  let chevronClasses = [__styles.chevron.base, __styles.chevron.align[chevronAlign]]; // console.log('currentItems', currentItems)
  ...
  return jsxRuntime.jsxs(RadixAccordion__namespace.Item, Object.assign({
    ...
    }), void 0), jsxRuntime.jsx(RadixAccordion__namespace.Content, Object.assign({
