...
function Group({
  ...
  const __styles = styleHandler['default']('checkbox');
...
function Checkbox(_a) {
  ...
  return jsxRuntime.jsx(CheckboxContext.CheckboxContext.Consumer, {
    children: ({
      ...
      const markupId = id ? id : name ? name : label ? label.toLowerCase().replace(/^[^A-Z0-9]+/gi, '').replace(/ /g, '-') : undefined; // @ts-ignore

      size = parentSize ? parentSize : size; // if name does not exist on Radio then use Context Name from Radio.Group
      // if that fails, use the id

      const markupName = name ? name : markupId; // check if checkbox checked is true or false
      // if neither true or false the checkbox will rely on native control

      let active = checked !== null && checked !== void 0 ? checked : undefined; // if (values && !value) value = values[id || name]
      ...
      return jsxRuntime.jsxs("div", Object.assign({
        ...
        children: [jsxRuntime.jsx("input", Object.assign({
          ...
          disabled: disabled
        }, props), void 0), jsxRuntime.jsxs("label", Object.assign({
