...
declare function Popover({ align, ariaLabel, arrow, children, className, defaultOpen, modal, onOpenChange, open, overlay, portalled, side, sideOffset, style, header, footer, size, }: RootProps): JSX.Element;
declare namespace Popover {
    var Seperator: () => JSX.Element;
    var Close: () => JSX.Element;
}
