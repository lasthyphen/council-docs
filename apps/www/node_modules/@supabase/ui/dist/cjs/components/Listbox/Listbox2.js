...
function Listbox({
  ...
  const __styles = styleHandler['default']('listbox');
  ...
  function handleOnChange(value) {
    ...
    event.target = {
      ...
      id: id,
      value: value,
      checked: undefined // outerHTML: undefined,
      // options: undefined,
      // multiple: undefined,
  ...
  if (!error) selectClasses.push(__styles.variants.standard); // if (icon) selectClasses.push(SelectStyles['sbui-listbox--with-icon'])

  if (icon) selectClasses.push(__styles.with_icon); // if (size) selectClasses.push(SelectStyles[`sbui-listbox--${size}`])

  if (size) selectClasses.push(__styles.size[size]); // if (borderless) selectClasses.push(SelectStyles['sbui-listbox--borderless'])
  ...
  return jsxRuntime.jsx(FormLayout.FormLayout, Object.assign({
    ...
    children: jsxRuntime.jsxs(RadixDropdown__namespace.Root, {
        ...
        children: jsxRuntime.jsxs("button", Object.assign({
          ...
          children: [jsxRuntime.jsxs("span", Object.assign({
            ...
            children: [icon && jsxRuntime.jsx(InputIconContainer['default'], {
              icon: icon
            }, void 0), (selectedNode === null || selectedNode === void 0 ? void 0 : selectedNode.addOnBefore) && jsxRuntime.jsx(selectedNode.addOnBefore, {}, void 0), jsxRuntime.jsx("span", Object.assign({
      ...
      }), void 0), jsxRuntime.jsx(RadixDropdown__namespace.Content, Object.assign({
        sideOffset: 6,
        loop: true,
        side: 'bottom',
        align: "center",
  ...
  return jsxRuntime.jsx(SelectContext.SelectContext.Consumer, {
    children: ({
      ...
      return jsxRuntime.jsxs(RadixDropdown__namespace.Item, Object.assign({
        className: classNames(__styles.option, active ? __styles.option_active : ' ', disabled ? __styles.option_disabled : ' '),
        ...
        }), void 0), active ? jsxRuntime.jsx("span", Object.assign({
