...
function Toggle(_a) {
  ...
  const __styles = styleHandler['default']('toggle');
  ...
  const [intChecked, setIntChecked] = React.useState((_b = defaultChecked || checked) !== null && _b !== void 0 ? _b : false); // check if toggle checked is true or false
  ...
  function onClick() {
    ...
    event.target = {
      ...
      id: id,
      value: !active,
      checked: !active // outerHTML: undefined,
      // options: undefined,
      // multiple: undefined,
