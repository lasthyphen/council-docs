...
var randomIdGenerator = require('../../utils/randomIdGenerator.js');
...
function RadioGroup({
  ...
  const __styles = styleHandler['default']('radio');
  ...
  if (values && !value) value = values[id || name]; // console.log('errors in. radio group', errors)
...
function Radio({
  ...
  return jsxRuntime.jsx(RadioContext.RadioContext.Consumer, {
    children: ({
      ...
      const markupId = id; // if name does not exist on Radio then use Context Name from Radio.Group

      const markupName = name || inputName; // console.log('markupName', markupName)
      // @ts-ignore

      size = parentSize || size; // check if radio id is via parent component
      ...
      let classes = [__styles.variants[type].container.base, // __styles.variants[type].container.align[align],
      ...
      return jsxRuntime.jsxs("label", Object.assign({
        ...
        children: [jsxRuntime.jsx("input", {
        ...
        }, void 0), addOnBefore, jsxRuntime.jsxs("div", Object.assign({
          ...
          children: [beforeLabel && jsxRuntime.jsx("span", Object.assign({
            ...
            children: label
          }, void 0), afterLabel && jsxRuntime.jsx("span", Object.assign({
        ...
        }), void 0), optionalLabel && jsxRuntime.jsx("div", Object.assign({
