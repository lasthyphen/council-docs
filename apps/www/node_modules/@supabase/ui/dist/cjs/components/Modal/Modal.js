...
const Modal = _a => {
  ...
  const __styles = styleHandler['default']('modal');

  React.useEffect(() => {
    setOpen(visible);
  }, [visible]);

  [__styles.base // ModalStyles[`sbui-modal`],
  ...
  return jsxRuntime.jsxs(Dialog__namespace.Root, Object.assign({
    ...
    children: [triggerElement && jsxRuntime.jsx(Dialog__namespace.Trigger // className={ModalStyles[`sbui-modal__trigger`]}
    , {
      ...
      children: [jsxRuntime.jsx(Dialog__namespace.Overlay, {
      ...
      }, void 0), jsxRuntime.jsx(Dialog__namespace.Overlay, Object.assign({
        ...
        children: jsxRuntime.jsxs(Dialog__namespace.Content, Object.assign({
          ...
          children: [header && jsxRuntime.jsx("div", Object.assign({
            ...
            children: header
          }), void 0), children, !hideFooter && jsxRuntime.jsx("div", Object.assign({
