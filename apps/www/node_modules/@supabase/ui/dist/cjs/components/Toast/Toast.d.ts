...
export declare namespace toast {
    var success: (message: string, opts?: Omit<Partial<Pick<ToastProps, "className" | "id" | "style" | "icon" | "type" | "closable" | "description" | "actions" | "duration" | "position" | "ariaProps" | "iconTheme" | "actionsPosition">>, "type"> | undefined) => string;
    var error: (message: string, opts?: Omit<Partial<Pick<ToastProps, "className" | "id" | "style" | "icon" | "type" | "closable" | "description" | "actions" | "duration" | "position" | "ariaProps" | "iconTheme" | "actionsPosition">>, "type"> | undefined) => string;
    var loading: (message: string, opts?: Omit<Partial<Pick<ToastProps, "className" | "id" | "style" | "icon" | "type" | "closable" | "description" | "actions" | "duration" | "position" | "ariaProps" | "iconTheme" | "actionsPosition">>, "type"> | undefined) => string;
