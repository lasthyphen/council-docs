...
function fieldInvariant(name, condition) {
    invariant_1.default(condition, 'Field not found in schema: "%s"', name);
}
...
class JSONSchemaBridge extends uniforms_1.Bridge {
    ...
    getError(name, error) {
        ...
        const nameParts = uniforms_1.joinName(null, name).map(uniforms_1.joinName.unescape);
        const unescapedName = uniforms_1.joinName(nameParts);
        const rootName = uniforms_1.joinName(nameParts.slice(0, -1));
    ...
    getField(name) {
        return uniforms_1.joinName(null, name).reduce((definition, next, index, array) => {
            var _a, _b, _c;
            var _d;
            const prevName = uniforms_1.joinName(array.slice(0, index));
            const nextName = uniforms_1.joinName(prevName, next);
            ...
            if (!isEmpty_1.default(properties)) {
    ...
    getInitialValue(name, props) {
        ...
        const { default: defaultValue = (_a = field.default) !== null && _a !== void 0 ? _a : get_1.default(this.schema.default, name), type = field.type, } = this._compiledSchema[name];
    ...
    getProps(name, fieldProps) {
        ...
        (_a = props.label) !== null && _a !== void 0 ? _a : (props.label = (_b = props.title) !== null && _b !== void 0 ? _b : upperFirst_1.default(lowerCase_1.default(uniforms_1.joinName(null, name).slice(-1)[0])));
