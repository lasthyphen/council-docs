...
function Group({
  ...
  const parentCallback = e => {// if (onChange) onChange(e)
  };
...
function Checkbox(_a) {
  ...
  return jsxRuntime.jsx(CheckboxContext.CheckboxContext.Consumer, {
    children: ({
      ...
      const markupId = id ? id : name ? name : label ? label.toLowerCase().replace(/^[^A-Z0-9]+/gi, '').replace(/ /g, '-') : undefined; // if name does not exist on Radio then use Context Name from Radio.Group
