  ...
  const handleSubmit = e => _tslib.__awaiter(this, void 0, void 0, function* () {
    ...
    switch (authView) {
      ...
      case 'sign_up':
        ...
        if (signUpError) setError(signUpError.message); // checking if it has access_token to know if email verification is disabled
        else if (signUpData === null || signUpData === void 0 ? void 0 : signUpData.hasOwnProperty('confirmation_sent_at')) setMessage('Check your email for the confirmation link.');
        break;
    }
    /*
