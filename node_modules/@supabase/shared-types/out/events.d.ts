...
export declare enum ProjectEvents {
...
export declare enum JwtSecretUpdateStatus {
    Updating = 0,
    Updated = 1,
    Failed = 2
}
export declare enum JwtSecretUpdateProgress {
    Started = 0,
    RestartedPostgreSQL = 1,
    UpdatedAPIServicesConfiguration = 2,
    RestartedAPIServices = 3,
    UpdatedDatabaseAdminAPIConfiguration = 4,
    UpdatedAPIGatewayConfiguration = 5
}
export declare enum JwtSecretUpdateError {
    PostgreSQLRestartFailed = 0,
    APIServicesConfigurationUpdateFailed = 1,
    APIServicesRestartFailed = 2,
    DatabaseAdminAPIConfigurationUpdateFailed = 3,
    SupabaseAPIKeyUpdateFailed = 4,
    APIGatewayUpdateFailed = 5
}
export declare enum DatabaseUpgradeStatus {
    Upgrading = 0,
    Upgraded = 1,
    Failed = 2
}
export declare enum DatabaseUpgradeProgress {
    Started = "1_started",
...
export declare enum DatabaseUpgradeError {
