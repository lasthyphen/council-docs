...
declare function Auth({ supabaseClient, socialLayout, providers, view, redirectTo, onlyThirdPartyProviders, magicLink, appearance, theme, localization, }: AuthProps): JSX.Element | null;
