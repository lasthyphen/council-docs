...
function Radio(props) {
    var _a;
    return wrapField_1.default(props, (_a = props.allowedValues) === null || _a === void 0 ? void 0 : _a.map(item => (react_1.default.createElement("div", { key: item, className: classnames_1.default(props.inputClassName, 'form-check', 'radio', {
