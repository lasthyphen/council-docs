...
function Select(_a) {
    ...
    return wrapField_1.default(Object.assign(Object.assign({}, props), { disabled,
        ...
        id,
        label,
        required }), checkboxes ? (allowedValues === null || allowedValues === void 0 ? void 0 : allowedValues.map(item => (react_1.default.createElement("div", { key: item, className: classnames_1.default(inputClassName, `checkbox${inline ? '-inline' : ''}`) },
